...
const gender = process.argv[2]; // Genero -                             Masculino (Linha 26). Gênero Feminino (Linha 44)
const height = process.argv[3]; // Altura -                             Masculino (Linha 26). Feminino (Linha 44)
const barReps = process.argv[4]; // Repetições com barra                Masculino (Linha 28). Feminino (Linha 46)
const barSeconds = process.argv[5]; // Tempo das repetições com barra   Masculino (Linha 28). Feminino (Linha 46)
const abs = process.argv[6]; // Abdominais                              Masculino (Linha 30). Feminino (Linha 48 )
const runDistance = process.argv[7]; // Distância da corrida            Masculino (Linha 32). Feminino (Linha 50)
const runTime = process.argv[8]; // Tempo da corrida                    Masculino (Linha 32 ). Feminino (Linha 50)
const swimDistance = process.argv[9]; // Distância da natação           Masculino (Linha 34). Feminino (Linha 52)
const swimTime = process.argv[10]; // Tempo da natação                  Masculino (Linha 34 ). Feminino (Linha 52)
const diveTime = process.argv[11]; // Tempo de mergulho                 Masculino (Linha 34 ). Feminino (Linha 52)
